  ...
  return (
    <div className="container bg-white mx-auto  px-10 py-10 min-h-screen ">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          <img
            src="https://i.ibb.co.com/mCBSRsSS/shutterstock-603317201-1.webp" 
            alt="Rare Blood Type"
      ...
      <div className="mt-12 space-y-8">
        <div>
          <h3 className="text-2xl text-black font-semibold mb-2">Importance of Rare Blood Types</h3>
          <p className="text-gray-800 text-lg leading-relaxed">
        ...
        <div>
          <h3 className="text-2xl text-black font-semibold mb-2">How You Can Help</h3>
          <p className="text-gray-800 text-lg leading-relaxed">
        ...
        <div>
          <h3 className="text-2xl text-black font-semibold mb-2">Stay Informed</h3>
          <p className="text-gray-800 text-lg leading-relaxed">
