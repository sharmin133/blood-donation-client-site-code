  ...
  return (
     <div className="container bg-white mx-auto  px-10 py-10 min-h-screen ">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          <img
            src="https://i.ibb.co.com/RThrqwPs/Why-the-Doctor.jpg" 
            alt="Cannot Donate"
      ...
      <div className="mt-12 space-y-8">
        <div>
          <h3 className="text-2xl text-black  font-semibold mb-2">Temporary Restrictions</h3>
          <p className="text-gray-800 text-lg leading-relaxed">
        ...
        <div>
          <h3 className="text-2xl text-black  font-semibold mb-2">Permanent Restrictions</h3>
          <p className="text-gray-800 text-lg leading-relaxed">
        ...
        <div>
          <h3 className="text-2xl  text-black font-semibold mb-2">Other Considerations</h3>
          <p className="text-gray-800 text-lg leading-relaxed">
